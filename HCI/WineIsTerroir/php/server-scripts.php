<?php
	...
	*/
	...
	function sendComment(){
		...
		$mailingList = stripcslashes($_POST['pmailingList']);

		$name = json_decode($name,TRUE);
		$email = json_decode($email,TRUE);
		$pnumber = json_decode($pnumber,TRUE);
		$comment = json_decode($comment,TRUE);
		$mailingList = json_decode($mailingList,TRUE);

		$conn = connectToDB();

		$sql = "INSERT INTO `comments_and_mailing_list`(`Name`, `Email`, `PhoneNumber`, `Comment`, `Mailing_List`) VALUES ('$name','$email','$pnumber','$comment','$mailingList')";
